...
npx poly function add createHash src/utilities/fxCreateHash.ts --context $CONTEXT --server --description "Generates a hash using hotelName, enterpriseId and chainCode" &&
